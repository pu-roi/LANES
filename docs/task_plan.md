...
> - [~] **Community Post Reporting Foundation** (`post.py`, `posts.py`, Alembic `c8a3d1f9e426`, `PostItem.tsx`) ([@roicambe](https://github.com/roicambe) (Roi Cambe)): Private authenticated reporting supports reason validation, required “Other” details, self-report prevention, and one open report per user/post. The shared dropdown/input/modal refactor and Moderation Center remain pending.
