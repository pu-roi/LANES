  ...
  return (
    <div className="relative flex-1 w-full overflow-hidden bg-slate-50 flex flex-col lg:flex-row">
      ...
      <motion.div
        ...
        animate={{ x: 0 }}
        transition={{ duration: 0.8, ease: [0.22, 1, 0.36, 1] }}
        className="relative z-20 flex-1 flex flex-col items-center justify-center p-4 sm:p-6 lg:p-10 lg:py-6 overflow-y-auto lg:ml-[44%] xl:ml-[42%] pb-[calc(var(--bottom-nav-height,1rem)+env(safe-area-inset-bottom,1rem))] lg:pb-6"
      >
        <div className="w-full flex flex-col items-center my-auto py-2 sm:py-4">
          ...
          <div className="w-full max-w-xl lg:ml-[-6%] xl:ml-[-8%] z-10 relative">
            {/* Form Header */}
            <div className="text-center lg:text-left space-y-1 mb-4 sm:mb-5 pl-2">
